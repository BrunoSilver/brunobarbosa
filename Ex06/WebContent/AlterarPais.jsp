                    ...
                    <form action="ManterPais.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" class="form-control" name="fone" id="populacao" maxlength="15" pattern="(?:\(\d{2}\)|\d{2})[- ]?\d{5}[- ]?\d{4}" placeholder="opcional; celular com ddd no formato (99) 99999-9999" value="${cliente.fone }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="email">area</label>
                                <input type="email" class="form-control" name="area" id="area" required maxlength="60" placeholder="email obrigatório" value="${cliente.email }">
                            </div>
                        </div>
                        <hr />
